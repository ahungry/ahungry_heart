...
(defn build-chains []
 ...
 Anari and I, we've long been acquaintances.  We were having a bit of fun."))
   ...
   (chain
    [(can-talk :uxana)
     (bin-party :uxzar)] :uxbana
      "So Zariel, what do you think of our group?" []
 ...
 own and make our mark on this quest!")
   ...
   (chain
    [(can-talk :uxath)
     (bin-party :uxolr)] :uxbath
      "So Olrun, what brings you to this quest?" []
 ...
 innocent and uphold justice. I am glad to stand beside you in this quest.")
   ...
   (chain
    ...
    "Alright everyone, I think it's time we discussed our plan.
