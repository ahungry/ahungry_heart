...
IF ~~ THEN BEGIN label_10
  SAY @333016
  IF ~!Global("ux_group_join_deny", "GLOBAL", 1)~ THEN
  REPLY @333017 DO ~SetGlobal("ux_in_party_olrun", "LOCALS", 1) SetGlobal("ux_request_group_join", "GLOBAL", 1) RealSetGlobalTimer("ux_olrun_banter_timer", "GLOBAL", 300) JoinParty()~   EXIT
  ++  @333018 DO ~SetGlobal("ux_in_party_olrun", "LOCALS", 1) SetGlobal("ux_group_join_deny", "GLOBAL", 1) RealSetGlobalTimer("ux_olrun_banter_timer", "GLOBAL", 300) JoinParty()~   EXIT
  ++ @333020 + label_9
END
