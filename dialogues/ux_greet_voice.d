...
IF ~~ THEN BEGIN label_26
  SAY @333016
  IF ~!Global("ux_group_join_deny", "GLOBAL", 1)~ THEN
  REPLY @333017 DO ~SetGlobal("ux_in_party_voice", "LOCALS", 1) SetGlobal("ux_request_group_join", "GLOBAL", 1) SetGlobal("ux_voice_banter_timer", "GLOBAL", 5) JoinParty() CreateCreature("uxpea")~   EXIT
  ++  @333018 DO ~SetGlobal("ux_in_party_voice", "LOCALS", 1) SetGlobal("ux_group_join_deny", "GLOBAL", 1) SetGlobal("ux_voice_banter_timer", "GLOBAL", 5) JoinParty() CreateCreature("uxpea")~   EXIT
  ++ @333031 + label_25
END
